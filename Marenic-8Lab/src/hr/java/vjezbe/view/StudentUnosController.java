...
public class StudentUnosController {
	...
	public void unesi() {
		...
		if (!errors.isEmpty()) {
			...
			Student noviStudent = new Student(maxId.getAsLong() + 1, txtIme.getText(), txtPrezime.getText(), txtJmbag.getText(), datePickerDatumRodjenja.getValue(), textAreaAdresa.getText());
	...
	private List<String> validateFields() {
		...
		if (Validation.isNullOrEmpty(textAreaAdresa.getText())) {
			errors.add("Unos adrese je obavezan");
		}
