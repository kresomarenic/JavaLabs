...
public class IspitController {
	...
	private void setRowFactory() {
		tablePretraga.setRowFactory(new Callback<TableView<Ispit>, TableRow<Ispit>>() {  
	        @Override  
	        public TableRow<Ispit> call(TableView<Ispit> tableView) {  
	            final TableRow<Ispit> row = new TableRow<>();  
	            final ContextMenu contextMenu = new ContextMenu();
	            final MenuItem removeMenuItem = new MenuItem("Obriši ispit");  
	            removeMenuItem.setOnAction(new EventHandler<ActionEvent>() {  
	                @Override  
	                public void handle(ActionEvent event) {
	                	ispiti.remove(row.getItem());
	                	Datoteke.spremiIspite(ispiti);                    
	                }  
	            });
