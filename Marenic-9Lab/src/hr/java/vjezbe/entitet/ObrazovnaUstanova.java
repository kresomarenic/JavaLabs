...
public abstract class ObrazovnaUstanova extends Entitet {
	...
	public static final String INPUT_FILE_NAME = "obrazovneUstanove.dat";
	public static final Integer NBR_OF_LINES_PER_RECORD = 7;
	
	public static final String TYPE_FAKULTET_RACUNARSTVA = "FAKULTET RAČUNARSTVA";
	public static final String TYPE_VELEUCILISTE_JAVE = "VELEUČILIŠTE JAVE";
